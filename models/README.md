...
* LSTM: Bowman et al. model having relu as activation function in the fully connected layers and using the Adam optimizer with a learning rate of 0.001.
* LSTM + images: Bowman et al. + images model having relu as activation function in the fully connected layers and using the Adam optimizer with a learning rate of 0.001.
