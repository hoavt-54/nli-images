...
~/python3 eval_bowman_vte_baseline.py --model_filename=checkpoints/VTE/VSNLI_train --test_filename=../datasets/snli_1.0/snli_1.0_test_filtered.tsv --img_names_filename=../../flickr30k-cnn/flickr30k/filenames_4096.json --img_features_filename=../../flickr30k-cnn/flickr30k/vgg_feats_4096.npy --result_filename=results/VTE/VSNLI_train_to_VSNLI_test

# Bowman et al. VSNLI train -> VSICK2

~/python3 eval_bowman_vte_baseline.py --model_filename=checkpoints/VTE/VSNLI_train --test_filename=../datasets/SICK/VSICK2/VSICK2.tsv --img_names_filename=../../flickr8k-cnn/flickr8k/filenames_4096.json --img_features_filename=../../flickr8k-cnn/flickr8k/vgg_feats_4096.npy --result_filename=results/VTE/VSNLI_train_to_VSICK2
