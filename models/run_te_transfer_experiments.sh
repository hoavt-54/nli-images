...
~/python3 eval_te_baseline.py --model_filename=checkpoints/te/snli_train_to_SICK2_train --test_filename=../datasets/SICK/SICK2/SICK2_test.tsv --result_filename=results/te/snli_train_to_SICK2_train_to_SICK2_test.txt
