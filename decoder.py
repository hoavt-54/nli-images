...
import  main
from models import SentenceMatchModelGraph
...
if __name__ == '__main__':
    ...
    testDataStream = main.SentenceMatchDataStream(in_path, word_vocab=word_vocab, char_vocab=char_vocab, 
...
#             saver = tf.train.Saver()
        ...
        accuracy = main.evaluate(testDataStream, valid_graph, sess, outpath=out_path, label_vocab=label_vocab,mode=args.mode,
